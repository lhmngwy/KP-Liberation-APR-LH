...
PAR_fn_deathSound = compileFinal preprocessFileLineNumbers "addons\PAR\PAR_fn_deathSound.sqf";
F_ejectUnit = compileFinal preprocessFileLineNumbers "addons\PAR\F_ejectUnit.sqf";
F_getRND = compileFinal preprocessFileLineNumbers "addons\PAR\F_getRND.sqf";
