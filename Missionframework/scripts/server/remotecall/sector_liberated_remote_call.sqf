...
switch (true) do {
    ...
    case (_liberated_sector in KPLIB_sectors_military):   {_KPLIB_enemyReadiness_increase = -(5 + (floor (random 10)) * KPLIB_param_difficulty);};
...
if (_KPLIB_enemyReadiness_increase > 0) then {
