...
KPLIB_b_mobileRespawn   = ["EO_TentDome_F", "B_T_Truck_01_medical_F", "B_Slingload_01_Medevac_F", "rksla3_lcvpmk5_viv_generic_grey"]; // This is the mobile respawn (and medical) truck.
